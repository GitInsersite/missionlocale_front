    ...
    <div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col px-4 font-semibold md:px-14 lg:px-20 xl:px-52">
          ...
          <p className="mb-6">
          En prenant directement contact avec nous, pour que nous puissions en détail parcourir les différentes étapes à effectuer. Une fois la contribution effectuée, vous recevrez un reçu libératoire pour justifier votre paiement auprès de l’URSAFF et/ou de votre expert-comptable.
          </p>
        </div>
