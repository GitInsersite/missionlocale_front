      ...
      <div>
        <div className=" flex flex-col items-center border-red-500 border-2 bg-[#F6F6F6]">
          ...
          <div className="border-2 border-[#2897d5] flex flex-col items-center px-4 bg-white rounded-3xl pt-2 w-[90%]">
            <h2 className="text-[#FFA500] font-bold mb-2 text-xl">
              ESPAC
              <span className="border-[#FFA500] border-b-2 pb-1">E ENTR</span>
              EPRISE
            </h2>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#FFA500] text-white py-1 p-2 rounded-md mb-8 font-semibold"
              >
                SE CONNECTER
              </button>
            </form>
