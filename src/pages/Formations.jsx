      ...
      <div className="bg-[#f6f6f6] md:px-14 lg:px-20 xl:px-44 lg:grid lg:grid-cols-2">
        {formations.map((newsItem, index) => (
          <div key={index} className="flex flex-col items-center pt-6 pb-6">
            <div className="bg-white mx-10 h-40 mb-10 rounded-xl flex w-[95%] md:h-48 lg:w-[90%]">
              ...
              <div className="w-[55%] p-1 flex flex-col items-center justify-center md:w-[65%] md:items-start md:pl-4 lg:w-[55%] xl:w-[60%]">
                <h3 className="font-bold mb-1 leading-tight  overflow-x-auto">
                  {newsItem.title}
                </h3>
