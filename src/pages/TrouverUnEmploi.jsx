              ...
              <form class="flex-auto p-6">
                <div className="flex flex-wrap t-20px l-20px relative">
                  ...
                  <p className="text-sm text-slate-500">
                    ...
                    ateliers, il vous suffit de consulter notre page «Ateliers»,
                    qui détaille chaque semaine les différents ateliers gratuits
                    qui sont disponibles pour vous aider à développer vos
