      ...
      {isTabletOrLarger ? (
        <div className="bg-[#F6F6F6]">
          ...
          <div className="breadcrumb px-4 pt-4 font-semibold md:px-14 lg:px-20 xl:px-52">
            ...
            <a className="text-[#D70B52]" href="/TrouverUnEmploi">
              Trouver un emploi
            </a>
          </div>{" "}
          <br />
                  ...
                  <form className="flex-auto p-6">
                    <div className="flex flex-wrap t-20px l-20px relative">
                      ...
                      <p className="text-sm text-slate-500">
                        Des équipes spécialisées en lien avec ton conseiller
                        sont là pour t’aider à trouver une emploi ! Elles sont
                        là pour négocier des offres d’emploi avec les
                        entreprises, organiser des actions de recrutement ainsi
                        que te préparer activement à la recherche d’emploi et à
                        la rencontre avec les employeurs.
                      </p>
                      <br />
                      <p className="text-sm text-slate-500">
                        N’hésite donc pas à prendre rendez-vous avec ton
                        conseiller si tu es à la recherche d’un emploi et pour
                        que l’on puisse te présenter nos conseils et nos
