...
function EtreAccompagne() {
  ...
  return (
    <div className="bg-[#F6F6F6]">
      ...
      <br />
      <div>
        <div className="flex flex-col pl-4 p-4 px-4 pt-4 font-semibold bg-[#F6F6F6] md:px-14 lg:px-20 xl:px-52">
              ...
              <form className="flex-auto p-6">
                <div className="flex flex-wrap t-20px l-20px relative">
                  ...
                  <p className="text-sm text-slate-500">
                    ...
                    attentes. Ces accompagnements seront aussi là pour t’aider
                    sur le plan social, tels que la santé, le logement ou bien
                    encore la mobilité.
                  </p>
                  <br />

                  <p className="text-sm text-slate-500">
                    Un conseiller est assigné pour t’accompagner et t’aider dans
                    toutes les démarches d’insertion, d’orientation, de
                    formation ou de recherche d’emploi. De nombreux dispositifs
