      ...
      {isTabletOrLarger ? (
        <div className="bg-[#F6F6F6]">
          ...
          <div className="breadcrumb px-4 pt-4 font-semibold md:px-14 lg:px-20 xl:px-52">
            ...
            <a className="text-[#D70B52]" href="/Etreaccompagne">
              {" "}
              Etre accompagné
            </a>
          </div>{" "}
                  ...
                  <form className="flex-auto p-6">
                    <div className="flex flex-wrap t-20px l-20px relative">
                      ...
                      <p className="text-sm text-slate-500">
                        Un accompagnement est proposé pour t’aider dans ta
                        recherche d’emploi ou de formation, personnalisé en
                        fonction de tes attentes. Ces accompagnements seront
                        aussi là pour t’aider sur le plan social, tels que la
                        santé, le logement ou bien encore la mobilité.
                      </p>{" "}
                      <br />
                      <p className="text-sm text-slate-500">
                        Un conseiller est assigné pour t’accompagner et t’aider
                        dans toutes les démarches d’insertion, d’orientation, de
                        formation ou de recherche d’emploi. De nombreux
                        dispositifs te seront alors présentés pour t’aider dans
                        tes démarches professionnelles (PACEA, CEJ,
                        Parrainage...) et sociales (Santé, Logement, Mobilité).
                      </p>
                      <div className="flex flex-col px-4 pt-4 font-semibold md:px-14 lg:px-20">
                        ...
                        <button
                          ...
                          className="bg-[#D60B52] text-white font-semibold py-2 text-center rounded-lg text-sm mb-6 md:w-64"
                        >
