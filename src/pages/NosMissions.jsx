  ...
  return (
    <div >
        ...
        <div className='flex flex-col mx-4 mt-4 md:mx-14 lg:mx-20'>
            <h1 className='font-bold text-black text-lg mb-8 md:text-2xl'><span className='border-b-2 border-pink-500 pb-[0.5px]'>Qui</span> sommes-nous ? </h1>
            ...
            <h1 className='font-bold text-black text-lg mb-8 md:text-2xl'><span className='border-b-2 border-pink-500 pb-[0.5px]'>Nos</span> Objectifs </h1>
            ...
            <h1 className='font-bold text-black text-lg mb-8 md:text-2xl'> <span className="border-b-2 border-pink-500 pb-[0.5px]">DISPOSITIFS</span></h1>
            <Link className="bg-pink-500 text-white font-semibold py-1 text-center rounded-lg mb-8 text-sm md:w-56">TELECHARGER NOTRE GUIDE</Link>
        </div>
    </div>
  )
}
