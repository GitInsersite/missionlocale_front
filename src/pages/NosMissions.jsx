function NosMissions() {
  ...
  return (
    <div className="bg-[#F6F6F6]">
      <div
        className="bg-image bg-cover bg-center h-12 flex justify-center items-center text-white font-bold sm:h-16 md:h-28 lg:h-40 xl:h-52 mb-11"
        style={{ backgroundImage: "url(MicrosoftTeams-image11.png)" }}
      >
        <h1 className="md:text-3xl">NOS MISSIONS</h1>
      </div>{" "}
      <br />
      <div className=" breadcrumb px-4 pt-4  md:px-14 lg:px-10 xl:px-56 mb-11">
        <a href="/">Accueil</a> {">"}
      ...
      >
        ...
        >
          <div className="flex flex-col mx-4 mt-4 md:mx-14 lg:mx-20 xl:mx-56">
            ...
            <p className="mb-11 mt-4 leading-tight ">
              {" "}
              ...
              Mission Locale, découvrez tout ce dont vous avez besoin pour
              trouver un emploi, un stage, ou une alternance. Cela passe par de
              ...
              avec des employeurs, et découverte des métiers pour vous
              accompagner dans votre orientation professionnelle. Nous vous
              accompagnons aussi dans toutes les tâches administratives que vous
            ...
            <p className="mb-11 mt-4 leading-tight ">
              ...
              Mission Locale des Mureaux, et ce pour quoi nous continuons
              d’agir.{" "}
            </p>

            <button
              className="bg-[#A4195C] text-white font-semibold py-1 text-center rounded-lg mb-11 mt-10 text-sm md:w-72 hover:bg-pink-700 transition-all duration-300"
